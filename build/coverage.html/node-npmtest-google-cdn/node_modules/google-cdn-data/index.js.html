...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-google-cdn/node_modules/google-cdn-data/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-google-cdn/node_modules/google-cdn-data/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-google-cdn/node_modules/google-cdn-data/</a> &#187; index.js</div>
</div>
<div class="body">
...
var data = module.exports = {
  jquery: {
    ...
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/jquery/' + version + '/jquery.min.js';</span>
    }
  },
  'jquery-ui': {
    ...
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/jqueryui/' + version + '/jquery-ui.min.js';</span>
    }
  },
  dojo: {
    ...
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/dojo/' + version + '/dojo/dojo.js';</span>
    }
  },
  swfobject: {
    versions: ['2.2', '2.1'],
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/swfobject/' + version + '/swfobject.js';</span>
    }
  },
  'angular-material': {
    versions: ['0.10.0', '0.9.4', '0.9.0', '0.8.3', '0.8.2', '0.8.1', '0.8.0', '0.7.1', '0.7.0', '0.6.1'],
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/angular_material/' + version + '/angular-material.min.js';</span>
    }
  }
};
&nbsp;
...
angularFiles.forEach(function (item) {
  ...
  data[item] = {
    ...
    url: <span class="fstat-no" title="function not covered" >function (version) {</span>
<span class="cstat-no" title="statement not covered" >      return '//ajax.googleapis.com/ajax/libs/angularjs/' + version + '/' + item + '.min.js';</span>
    }
  };
});
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 18:38:49 GMT+0000 (UTC)</div>
</div>
</body>
</html>
